...
export default class JSXHome extends React.Component {
render() {
return (
  <body>
  <div>
 <div class="container-fluid bg-dark py-3 px-lg-5 d-none d-lg-block">
    ...
    <div class="container-fluid position-relative nav-bar p-0">
        <div class="position-relative px-lg-5" styles="z-index: 9;">
    ...
    <div class="container-fluid bg-white pt-3 px-lg-5">
        <div class="row mx-n2">
            <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                <select class="custom-select px-4 mb-3" styles="height: 50px;">
            ...
            <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                <button class="btn btn-primary btn-block mb-3" type="submit" styles="height: 50px;">Search</button>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row mx-0">
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-secondary d-flex align-items-center justify-content-between" styles="height: 350px;">
                      <div>
...
ReactDOM.render(<JSXHome />, document.getElementById('root'));